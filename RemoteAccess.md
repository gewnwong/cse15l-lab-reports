...
<img width="608" alt="Screenshot 2023-01-12 at 10 59 00 PM" src="https://user-images.githubusercontent.com/122576781/212257233-1de1ade1-9867-4ef1-b466-5711bb339dd6.png">
 ...
 I also performed similar commands on my computer after using the ```exiteegfeegmeeg``` command so I could better understand the progression within my terminal from my finder.
...
I thought it was interesting to be able to go through the finder I've always been using in a different format. This lab was also the one of the first times I opened the Terminal app on my computer to actively do something; previously, I hadn't really acknowledged that it held a function.
